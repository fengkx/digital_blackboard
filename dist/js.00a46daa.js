...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/_empty.js":[function(require,module,exports) {

},{}],"node_modules/acorn/dist/acorn.es.js":[function(require,module,exports) {
"use strict";
...
var paper = function (self, undefined) {
  ...
  var Path = PathItem.extend({
    ...
    initialize: function Path(arg) {
      ...
      this._segments = [];
      this._version = 0;
      var segments = Array.isArray(arg) ? _typeof(arg[0]) === 'object' ? arg : arguments : arg && arg.size === undefined && (arg.x !== undefined || arg.point !== undefined) ? arguments : null;
...
},{"./node/self.js":"../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/_empty.js","acorn":"node_modules/acorn/dist/acorn.es.js","./node/extend.js":"../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/_empty.js","process":"../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/hammerjs/hammer.js":[function(require,module,exports) {
var define;
...
},{"./common":"node_modules/debug/src/common.js","process":"../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var dd = (0, _debug.default)('drawing');
var md = (0, _debug.default)('menu'); //globalState and basiclly default value
...
var globalState = {
  ...
  strokeColor: '#ffffff',
  lastPointsNum: 0,
  // record the pointsNum,
  menuTimeOutId: undefined
};
var currPath;

window.onload = function () {
  (0, _debug.default)('window Load!');
  var board = document.getElementById('board'); // set up paper.js

  _paper.default.setup(board);

  localStorage.getItem('digital-board@drwaing#active') && _paper.default.project.activeLayer.importJSON(localStorage.getItem('digital-board@drwaing#active')); //debug mode

  _paper.default.install(window); // bind color of input to its father's bgcolor


  var strokeColorInput = document.getElementById('stroke-color');
  var strokeColorInputWrapper = document.getElementById('stroke-color-wrapper');
  ...
  var strokeSizeIncBtn = document.getElementById('inc-stroke-size');
  var strokeSizeDecBtn = document.getElementById('dec-stroke-size');
  var realStrokeSize = document.getElementById('real-stroke-size');
  realStrokeSize.innerText = defaultOptions.strokeWidth;
  strokeSizeIncBtn.addEventListener('click', function (ev) {
    var size = parseInt(realStrokeSize.innerText);
  ...
  var exportBtn = document.getElementById('save-to-localstorage');
  var importBtn = document.getElementById('import-from-localstorage');
  exportBtn.addEventListener('click', function (ev) {
    localStorage.setItem('digital-board@drwaing#active', _paper.default.project.activeLayer.exportJSON());
  });
  importBtn.addEventListener('click', function (ev) {
    var json = localStorage.getItem('digital-board@drwaing#active');

    _paper.default.project.activeLayer.importJSON(json);
  }); // download to file

  var downloadBtn = document.getElementById('download-file');
  downloadBtn.addEventListener('click', function (ev) {
    var url = board.toDataURL('image/png').replace('image/png', 'image/octet-stream');
    var d = new Date();
    var filename = "export-".concat(d.getFullYear(), "-").concat(d.getFullYear(), "-").concat(d.getFullYear(), "-").concat(d.getMonth() + 1, "-").concat(d.getMinutes(), "-").concat(d.getSeconds(), ".png");
  ...
  var swipe = new _hammerjs.default.Swipe({
    event: 'show-menu',
    direction: _hammerjs.default.DIRECTION_UP
  });
  guestureDector.add(swipe);

  var hidenMenu = function hidenMenu() {
  ...
  document.getElementById('bottom-bar').querySelector('.menu').addEventListener('click', function (ev) {
...
function startDraw(ev) {
  ...
  options = Object.assign(_objectSpread({}, defaultOptions), options);
  var path = new _paper.default.Path(options);
  return path;
}
...
},{"paper":"node_modules/paper/dist/paper-full.js","hammerjs":"node_modules/hammerjs/hammer.js","debug":"node_modules/debug/src/browser.js","../styles/style.scss":"styles/style.scss","@fortawesome/fontawesome-free/css/all.css":"node_modules/@fortawesome/fontawesome-free/css/all.css"}],"../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
