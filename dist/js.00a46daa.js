...
window.onload = function () {
  ...
  _paper.default.install(window);

  var currPath; //globalState and basiclly default value

  var globalState = {
    backgroudColor: '#000000',
    strokeWidth: 4,
    strokeColor: '#ffffff' // bind color of input to its father's bgcolor
